			...
			<tr>
				...
				<td>
							<ul>
								...
								<li><a href="http://www.gregsandell.com/portfolio/portfolioPopup.php?site=watts" TARGET=_BLANK >Visit live site</a></li>
							</ul>
				</td>
			</tr>
		</table>
...
<?php
			...
			<tr class="docDescription">
				<td><a href="../portfolioPopup.php?pdf=watts/docs/wattsProjectOverview.pdf" TARGET=_BLANK><img src="../pdfIcon.gif" width="32" height="32" border="0"></a></td>
				<td><a href="../portfolioPopup.php?pdf=watts/docs/wattsProjectOverview.pdf" TARGET=_BLANK>Project Overview</a></td>
				<td><p>An overview of the business and technical goals of the site.</p>
				</td>
			</tr>
			<tr class="docDescription">
				<td><a href="../portfolioPopup.php?pdf=watts/docs/wattsDevelopmentTimeline.pdf" TARGET=_BLANK><img src="../pdfIcon.gif" width="32" height="32" border="0"></a></td>
				<td><a href="../portfolioPopup.php?pdf=watts/docs/wattsDevelopmentTimeline.pdf" TARGET=_BLANK>Development Timeline</a></td>
				<td><p>A timeline of the full-life-cycle development process.</p>
				</td>
			</tr>
			<tr class="docDescription">
				<td><a href="../portfolioPopup.php?pdf=watts/docs/wattsSitemap.pdf" TARGET=_BLANK><img src="../pdfIcon.gif" width="32" height="32" border="0"></a></td>
				<td><a href="../portfolioPopup.php?pdf=watts/docs/wattsSitemap.pdf" TARGET=_BLANK>Site Map</a></td>
				<td><p>Original site map of the Edwin Watts site.</p>
				</td>
			</tr>
			<tr class="docDescription">
				<td><a href="../portfolioPopup.php?pdf=watts/docs/wattsDatabaseDesign.pdf" TARGET=_BLANK><img src="../pdfIcon.gif" width="32" height="32" border="0"></a></td>
				<td><a href="../portfolioPopup.php?pdf=watts/docs/wattsDatabaseDesign.pdf" TARGET=_BLANK>Database Design</a></td>
				<td>
			...
			<tr class="docDescription">
				<td><a href="../portfolioPopup.php?pdf=watts/docs/wattsProductPageFlow.pdf" TARGET=_BLANK><img src="../pdfIcon.gif" width="32" height="32" border="0"></a></td>
				<td><a href="../portfolioPopup.php?pdf=watts/docs/wattsProductPageFlow.pdf" TARGET=_BLANK>Product Page Flow</a></td>
				<td><p>This document is a scan of VISIO flows showing the process of assembling a product page.</p>
				</td>
			</tr>
			<tr class="docDescription">
				<td><a href="../portfolioPopup.php?pdf=watts/docs/wattsCustomerInfo.pdf" TARGET=_BLANK><img src="../pdfIcon.gif" width="32" height="32" border="0"></a></td>
				<td><a href="../portfolioPopup.php?pdf=watts/docs/wattsCustomerInfo.pdf" TARGET=_BLANK>Customer Information Flow</a></td>
				<td><p>This document is a scan of VISIO flows showing the process of collecting customer information.</p>
				</td>
			</tr>
			<tr class="docDescription">
				<td><a href="../portfolioPopup.php?pdf=watts/docs/wattsShoppingCartFlow.pdf" TARGET=_BLANK><img src="../pdfIcon.gif" width="32" height="32" border="0"></a></td>
				<td><a href="../portfolioPopup.php?pdf=watts/docs/wattsShoppingCartFlow.pdf" TARGET=_BLANK>Shopping Cart Flows</a></td>
				<td><p>This document is a scan of VISIO flows showing shopping cart processing.</p>
				</td>
			</tr>
			<tr class="docDescription">
				<td><a href="../portfolioPopup.php?pdf=watts/docs/wattsCheckout.pdf" TARGET=_BLANK><img src="../pdfIcon.gif" width="32" height="32" border="0"></a></td>
				<td><a href="../portfolioPopup.php?pdf=watts/docs/wattsCheckout.pdf" TARGET=_BLANK>Checkout Flows</a></td>
				<td><p>This document is a scan of VISIO flows showing the checkout and payment process.</p> </td>
			</tr>
			<tr class="docDescription">
				<td><a href="../portfolioPopup.php?pdf=watts/docs/wattsShippingFlow.pdf" TARGET=_BLANK><img src="../pdfIcon.gif" width="32" height="32" border="0"></a></td>
				<td><a href="../portfolioPopup.php?pdf=watts/docs/wattsShippingFlow.pdf" TARGET=_BLANK>Shipping Flows</a></td>
