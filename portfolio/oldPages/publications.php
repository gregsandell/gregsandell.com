<html>
	...
	<body>
		<table border="0" cellspacing="0" cellpadding="0" width="100%" height="100%">
			...
			You are here: <a class="bread" href="../index.php">Home</a> &gt; Publications</a>
				</td>
			</tr>
			<tr>
				<td width="100%" valign="top" align="left">
					<table border="0" width="500">
						<tr class="docHeader">
							<td align="left"><br/>Greg Sandell's Publications</td>
						</tr>
						<tr>
							<td>
<p>Prior to becoming a professional software
developer, Greg Sandell was a graduate student and then academic researcher in
various disciplines relating to music and human hearing: auditory grouping, Digital Signal Processing
for music synthesis, acoustics of musical instruments, and orchestration.</p>
<dl>
...
<dd>Title:  "Concurrent Timbres in
Orchestration: a Perceptual Study of Factors Determining 'blend'<br/>
